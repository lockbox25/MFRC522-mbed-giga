...
MFRC522::MFRC522(SPIClass* spi): MFRC522(SS, UINT8_MAX) { // SS is defined in pins_arduino.h, UINT8_MAX means there is no connection from Arduino to MFRC522's reset and power down input
	_spi = spi;
} // End constructor
